...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, 'trial', 'templates'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
CSRF_COOKIE_HTTPONLY = False  # Required for accessing the cookie in JavaScript
...
API = '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'